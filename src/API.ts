...
export type ModelSubscriptionListFilterInput = {
  ...
  sharedWith?: ModelSubscriptionStringInput | null,
...
export type CustomAlbumListsByUserQueryVariables = {
  userId: string,
...
export type CustomAlbumListsByUserQuery = {
  listsByUser?:  {
    __typename: "ModelListConnection",
    items:  Array< {
      __typename: "List",
...
export type CustomListListeningPileEntriesQueryVariables = {
  filter?: ModelListeningPileEntryFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};

export type CustomListListeningPileEntriesQuery = {
...
export type CustomAlbumListsByAlbumIdAndIdQueryVariables = {
  albumId: string,
...
export type CustomAlbumListsByAlbumIdAndIdQuery = {
...
export type AlbumListsByUserFilteredQueryVariables = {
  userId: string,
  albumId?: string | null,
  listId?: string | null,
  limit?: number | null,
...
export type AlbumListsByUserFilteredQuery = {
  albumListsByUser?:  {
    __typename: "ModelAlbumListConnection",
    items:  Array< {
      __typename: "AlbumList",
...
export type SharedListsByUserQueryVariables = {
  usernameOrEmail: string,
  limit?: number | null,
  nextToken?: string | null,
};

export type SharedListsByUserQuery = {
  listLists?:  {
    __typename: "ModelListConnection",
    items:  Array< {
      __typename: "List",
...
export type ShareListMutationVariables = {
  listId: string,
  userId: string,
};
...
export type UnshareListMutationVariables = {
  listId: string,
  userId: string,
};

export type UnshareListMutation = {
  unshareList?:  {
    __typename: "List",
    id: string,
    name: string,
...
export type ToggleListVisibilityMutationVariables = {
  listId: string,
  isPublic: boolean,
};

export type ToggleListVisibilityMutation = {
