...
const SPOTIFY_CLIENT_ID = process.env.REACT_APP_SPOTIFY_CLIENT_ID || "fdd4506a23df430aacb2c4aa3b87bd24";
const SPOTIFY_CLIENT_SECRET = process.env.REACT_APP_SPOTIFY_CLIENT_SECRET || "56672579f0aa42e5b9c53b155bf28c15";
